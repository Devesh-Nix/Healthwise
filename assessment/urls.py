...
urlpatterns = [
    ...
    # path('report/<int:patient_id>/attempt/<int:attempt_id>/', views.generate_report_attempt, name='generate_report_attempt'),
    ...
    path('select-test/', select_test, name='select_test'),
